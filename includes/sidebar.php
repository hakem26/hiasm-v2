  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        <!-- داشبورد — همه -->
        <li class="nav-item">
          <a class="nav-link <?= isActive('/pages/dashboard') ?>" href="<?= BASE_URL ?>/pages/dashboard.php">
        ...
        <?php if (hasPermission('partners.view')): ?>
          <!-- ── شریک‌ها ──────────────────────────────────── -->
          <li class="nav-item">
            <a class="nav-link <?= isActive('/modules/partners') ?>" href="<?= BASE_URL ?>/modules/partners/list.php">
        ...
        <?php if (hasPermission('customers.view')): ?>
          <!-- ── مشتریان ──────────────────────────────────── -->
          <li class="nav-item">
            <a class="nav-link <?= isActive('/modules/customers') ?>" href="<?= BASE_URL ?>/modules/customers/list.php">
              <span class="nav-link-icon"><i class="ti ti-users"></i></span>
              <span class="nav-link-title">مشتریان</span>
            </a>
          </li>
        <?php endif; ?>
        ...
        <?php if (hasPermission('products.view')): ?>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle <?= isActive('/modules/products') ?>" href="#products-menu"
        ...
        <?php if (hasPermission('inventory.view_own')): ?>
          <!-- ── انبار ────────────────────────────────────── -->
          <li class="nav-item">
            <a class="nav-link <?= isActive('/modules/inventory') ?>" href="<?= BASE_URL ?>/modules/inventory/list.php">
        ...
        <?php if (hasPermission('reports.own')): ?>
          <!-- ── گزارش‌ها ──────────────────────────────────── -->
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle <?= isActive('/modules/reports') ?>" href="#reports-menu"
              data-bs-toggle="dropdown">
        ...
        <?php if (hasPermission('users.manage')): ?>
          ...
          <li class="nav-item">
            <a class="nav-link <?= isActive('/modules/users') ?>" href="<?= BASE_URL ?>/modules/users/list.php">
