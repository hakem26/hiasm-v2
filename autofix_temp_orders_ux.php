<?php
/**
 * بهبود UX صفحه temp_orders/list.php
 * اضافه کردن modal تبدیل مستقیم از لیست
 */

$listFile = __DIR__ . '/modules/temp_orders/list.php';
...
file_put_contents($listFile, $newList);
echo "<p style='color:green;font-family:Tahoma'>✓ temp_orders/list.php بروزرسانی شد — دکمه تبدیل مستقیم اضافه شد</p>";
